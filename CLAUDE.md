...
- **Dual soul file architecture** — VisibleSoulFile (user-facing, "accurate and loving") + HiddenSoulFile (agent-facing, clinical). Generated by assessment → visible narrative / hidden clinical pipeline, with single-call fallback.
