                ...
                ScrollView {
                    VStack(spacing: 24) {
                        ...
                        infoCard(
                            ...
                            title: "How It Works",
                            body: "You talk to Magpie — an AI that listens, asks real questions, and builds a living portrait of who you are. Then Magpie finds you someone you can actually connect with."
                        )

                        infoCard(
                            icon: "lock.shield",
                            title: "Your Words Stay Yours",
                            body: "Everything you share is private and never shared directly with anyone without your consent. Your data is safe with Magpie."
                        )
                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 16) {
                        section(
                            ...
                            body: "When you use Magpie, we collect the conversation messages you send and a device identifier to associate your data with your account."
                        )
