...
| A living portrait | A label (MBTI, Enneagram) |
| Self-knowledge | Therapy or medical advice |
| Your own words | Psychology jargon |
...
> "Not 'you're an INTJ.' More like: 'You move through the world like someone who built walls to protect their creative space, then forgot where you put the door.'"

## Screenshot descriptions
1. **Welcome screen** — "Welcome — This is a space for honest reflection. There are no right answers — only yours."
2. **Conversation** — Mid-conversation showing the AI quoting the user's words back
3. **Soul file portrait** — The generated portrait text in serif font
4. **Soul file sections** — Gold-labeled sections (HOW YOU THINK, YOUR CONTRADICTIONS)
5. **Crystallized moments** — Verbatim user quotes preserved as mirrors
