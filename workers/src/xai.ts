...
export async function fetchInterestNews(topics: string[], xaiToken: string): Promise<XaiNewsItem[]> {
  if (topics.length === 0) {
    return [];
  }
...
export { extractText as _extractText, parseJsonArray as _parseJsonArray };
